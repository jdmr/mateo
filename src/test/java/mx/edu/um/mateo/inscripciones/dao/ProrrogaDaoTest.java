...
public class ProrrogaDaoTest {
    ...
    public void testLista() {
        ...
        for (int i = 0; i < 20; i++) {
            prorroga = new Prorroga("1110475", new Date(), new Date(), "test", new Double("2369.8"), usuario.getNombre(), "a");
    ...
    public void testObtiene() {
        ...
        Prorroga prorroga = new Prorroga("1110475", new Date(), new Date(), "test", new Double("2369.8"), usuario.getNombre(), "a");
        prorroga.setObservaciones("test");
        instance.graba(prorroga, usuario);
        assertNotNull(prorroga.getId());
