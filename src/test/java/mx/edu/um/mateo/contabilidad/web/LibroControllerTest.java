...
public class LibroControllerTest extends BaseTest {
    ...
    public void debieraMostrarLibro() throws Exception {
        ...
        this.mockMvc.perform(
                get(Constantes.PATH_CUENTA_LIBRO_VER + "/" + libro.getId())).andExpect(status().isOk()).andExpect(forwardedUrl("/WEB-INF/jsp/" + Constantes.PATH_CUENTA_LIBRO_VER + ".jsp")).andExpect(model().attributeExists(Constantes.ADDATTRIBUTE_LIBRO));
    }
