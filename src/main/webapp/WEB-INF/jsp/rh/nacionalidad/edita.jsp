...
<html>
    <head>
        <title><s:message code="nacionalidad.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-nacionalidad" class="content scaffold-list" role="main">
            <h1><s:message code="nacionalidad.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/rh/nacionalidad/actualiza" />
            <form:form commandName="nacionalidad" action="${actualizaUrl}" method="post">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/rh/nacionalidad/ver/${nacionalidad.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
        <content>
