            ...
            <form:form commandName="empleadoPerDed" action="${eliminaUrl}" >
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span4">
                        ...
                        <h3>${empleadoPerDed.perDed.clave}</h3>
                    </div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span4">
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span4">
                        ...
                        <h3><c:if test="${not empleadoPerDed.porcentaje}">$</c:if>${empleadoPerDed.importe}<c:if test="${empleadoPerDed.porcentaje}">%</c:if></h3>
                    </div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span4">
                        <h4><s:message code="atributos.label" /></h4>
                        <h3>${empleadoPerDed.atributos}</h3>
                    </div>
                </div>
