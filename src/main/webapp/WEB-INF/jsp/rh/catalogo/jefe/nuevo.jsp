...
<html>
    <head>
        <title><s:message code="jefe.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-nacionalidad" class="content scaffold-list" role="main">
            ...
            <form:form commandName="jefe" action="graba" method="post">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/rh/jefe '/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
