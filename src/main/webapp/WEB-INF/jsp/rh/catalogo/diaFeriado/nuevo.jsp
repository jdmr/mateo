...
<html>
    <head>
        <title><s:message code="diaFeriado.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-nacionalidad" class="content scaffold-list" role="main">
            <h1><s:message code="diaFeriado.nuevo.label" /></h1>
            <p class="well">
            ...
            <form:form commandName="diaFeriado" action="graba" method="post">
                <form:errors path="*">
                ...
                <fieldset>
                    ...
                    <s:bind path="diaFeriado.descripcion">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                <label for="dado">
                                <s:message code="diadado.label" />
                                <span class="required-indicator">*</span>
                            </label>
                            <form:checkbox path="dado" value="true" required="true" cssClass="span3" />
                            <form:errors path="dado" cssClass="alert alert-error" />
                        </div>
                    </s:bind>
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/rh/diaFeriado'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
