...
<html>
    <head>
        <title><s:message code="categoria.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-categoria" class="content scaffold-list" role="main">
            <h1><s:message code="categoria.edita.label" /></h1>
            <p class="well">
            ...
            <form:form commandName="categoria" action="${actualizaUrl}" method="post">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/rh/categoria/ver/${tipoCliente.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
        <content>
