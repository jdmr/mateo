...
<html>
    <head>
        <title><s:message code="categoria.lista.label" /></title>
    </head>
    <body>
        ...
        <h1><s:message code="categoria.lista.label" /></h1>
        <hr/>

        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/rh/categoria' />">
