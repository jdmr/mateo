                ...
                <tbody>
                    <c:forEach items="${empleadoVacaciones}" var="vacacionEmpleado" varStatus="status">
                        <tr class="${status.index % 2 == 0 ? 'even' : 'odd'}">
                            <td><a href="<c:url value='/rh/vacacionesEmpleado/ver/${vacacionEmpleado.id}' />">${vacacionEmpleado.fechaInicio}</a></td>
                            <td>${vacacionEmpleado.fechaFinal}</td>
                            <td>${vacacionEmpleado.observaciones}</td>
                            <td><input type="checkbox" value="" disabled="true" <c:if test="${vacacionEmpleado.primaVacacional}">checked="checked"</c:if> />
                                </td>
                            </tr>
                    </c:forEach>
                </tbody>
