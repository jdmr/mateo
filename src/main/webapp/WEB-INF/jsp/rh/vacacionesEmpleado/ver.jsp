        ...
        <div id="ver-nacionalidad" class="content scaffold-list" role="main">
            ...
            <form:form commandName="vacacionEmpleado" action="${eliminaUrl}" >
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    ...
                    <div class="span11">${vacacionEmpleado.fechaInicio}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="fechaFinal.label" /></div>
                    <div class="span11">${vacacionEmpleado.fechaFinal}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="observaciones.label" /></div>
                    <div class="span11">${vacacionEmpleado.observaciones}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="telefono.label" /></div>
                    <div class="span11">${vacacionEmpleado.contactoTelefono}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="correo.label" /></div>
                    <div class="span11">${vacacionEmpleado.contactoCorreo}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="primaVacacional.label" /></div>
                    <div class="span11"><input type="checkbox" value="" disabled="true" <c:if test="${vacacionEmpleado.primaVacacional}">checked="checked"</c:if> />
                        </div>
                    </div>
