    ...
    <body>
        ...
        <div id="ver-colegio" class="content scaffold-list" role="main">
            ...
            <p class="well">
                ...
                <a class="btn btn-primary" href="<s:url value='/rh/colegio/nuevo'/>"><i class="icon-user icon-white"></i> <s:message code='colegio.nuevo.label' /></a>
            </p>
            ...
            <c:url var="eliminaUrl" value="/rh/colegio/elimina" />
            <form:form commandName="colegio" action="${eliminaUrl}" >
                ...
                <p class="well">
                    <a href="<c:url value='/rh/colegio/edita/${colegio.id}' />" class="btn btn-primary btn-large"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                    <form:hidden path="id" />
