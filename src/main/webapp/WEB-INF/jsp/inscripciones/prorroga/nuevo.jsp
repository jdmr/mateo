...
<html>
    <head>
        <title><s:message code="prorroga.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-colegio" class="content scaffold-list" role="main">
            ...
            <form:form commandName="prorroga" action="graba" method="post">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/prorroga'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
