...
<html>
    <head>
        <title><s:message code="paquete.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="edita-colegio" class="content scaffold-list" role="main">
            <h1><s:message code="paquete.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/inscripciones/paquete/graba" />
            <form:form commandName="paquete" method="post" action="${actualizaUrl}">
                <form:errors path="*">
