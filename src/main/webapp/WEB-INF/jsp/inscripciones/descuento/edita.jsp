...
<html>
    <head>
        <title><s:message code="descuento.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="edita-descuento" class="content scaffold-list" role="main">
            <h1><s:message code="descuento.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/inscripciones/descuento/graba" />
            <form:form commandName="descuento" method="post" action="${actualizaUrl}">
                <form:errors path="*">
                ...
                <fieldset>
                    <s:bind path="descuento.descripcion">
                    ...
                    <s:bind path="descuento.contabiliza">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/descuento/ver/${descuento.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
