...
<html>
    <head>
        <title><s:message code="tiposBecas.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-tiposBecas" class="content scaffold-list" role="main">
            <h1><s:message code="tiposBecas.nuevo.label" /></h1>
            <p class="well">
            ...
            <form:form commandName="tipoBeca" action="graba" method="post">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/tiposBecas'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
