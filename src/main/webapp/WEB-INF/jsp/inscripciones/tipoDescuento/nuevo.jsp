...
<html>
    <head>
        <title><s:message code="tipoDescuento.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-colegio" class="content scaffold-list" role="main">
            <h1><s:message code="tipoDescuento.nuevo.label" /></h1>
            <p class="well">
            ...
            <form:form commandName="tipoDescuento" action="graba" method="post">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/tipoDescuento'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
