...
<html>
    <head>
        <title><s:message code="afePlaza.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="edita-colegio" class="content scaffold-list" role="main">
            <h1><s:message code="afePlaza.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/inscripciones/afePlaza/actualiza" />
            <form:form commandName="afePlaza" method="post" action="${actualizaUrl}">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/afePlaza/ver/${afePlaza.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
