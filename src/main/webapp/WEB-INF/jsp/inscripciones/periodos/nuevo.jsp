...
<html>
    <head>
        <title><s:message code="periodo.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-periodo" class="content scaffold-list" role="main">
            <h1><s:message code="periodo.nuevo.label" /></h1>
            <p class="well">
            ...
            <form:form commandName="periodo" action="graba" method="post">
                <form:errors path="*">
                ...
                <fieldset>
                    <s:bind path="periodo.descripcion">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                            ...
                            <form:input path="descripcion" maxlength="100" required="true" cssClass="span3" />
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/periodos'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
        <content>
