...
<html>
    <head>
        <title><s:message code="alumnoDescuento.nuevo.label" /></title>
    </head>
    <body>
        ...
        <div id="nuevo-colegio" class="content scaffold-list" role="main">
            <h1><s:message code="alumnoDescuento.nuevo.label" /></h1>
            <p class="well">
            ...
            <form:form commandName="alumnoDescuento" action="graba" method="post">
                <form:errors path="*">
                ...
                <fieldset>
                    ...
                    <s:bind path="alumnoDescuento.fecha">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                            ...
                            <form:input path="fecha" maxlength="20" required="true" />
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/alumnoDescuento'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
