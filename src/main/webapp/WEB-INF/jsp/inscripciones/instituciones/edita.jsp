...
<html>
    ...
    <body>
        ...
        <div id="nueva-institucion" class="content scaffold-list" role="main">
            <h1><s:message code="institucion.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/inscripciones/instituciones/graba" />
            <form:form commandName="institucion" action="${actualizaUrl}" method="post">
                <form:hidden path="id" />
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/inscripciones/institucion/ver/${periodo.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
        <content>
