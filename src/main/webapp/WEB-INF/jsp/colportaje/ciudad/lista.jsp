...
<html>
    ...
    <body>
        ...
        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/colportaje/ciudad' />">
                ...
                <tbody>
                    <c:forEach items="${ciudades}" var="ciudad" varStatus="status">
                        <tr class="${status.index % 2 == 0 ? 'even' : 'odd'}">
                            <td><a href="<c:url value='/colportaje/ciudad/ver/${ciudad.id}' />">${ciudad.nombre}</a></td>
                            <td>${ciudad.estado.nombre}</a></td>
                            <td>${ciudad.estado.pais.nombre}</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
