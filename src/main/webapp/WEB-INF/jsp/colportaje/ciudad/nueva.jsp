...
<html>
    ...
    <body>
        ...
        <div id="nueva-ciudad" class="content scaffold-list" role="main">
            ...
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/colportor/ciudad'/>"><i class="icon-list icon-white"></i> <s:message code='ciudad.lista.label' /></a>
            </p>
            <form:form commandName="ciudad" action="crea" method="post">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/colportor/ciudad'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    </body>
