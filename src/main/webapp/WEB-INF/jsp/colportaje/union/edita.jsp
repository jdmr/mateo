...
<html>
    ...
    <body>
        ...
        <div id="edita-union" class="content scaffold-list" role="main">
            ...
            <c:url var="actualizaUrl" value="/colportaje/union/actualiza" />
            <form:form commandName="union" method="post" action="${actualizaUrl}">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/colportaje/union/ver/${union.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    </body>
