    ...
    <body>
        ...
        <div id="ver-asociacion" class="content scaffold-list" role="main">
            ...
            <p class="well">
                ...
                <a class="btn btn-primary" href="<s:url value='/colportaje/asociacion/nueva'/>"><i class="icon-file icon-white"></i> <s:message code='asociacion.nueva.label' /></a>
            </p>
            ...
            <c:url var="eliminaUrl" value="/colportaje/asociacion/elimina" />
            <form:form commandName="asociacion" action="${eliminaUrl}" >
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    ...
                    <div class="span4">
                        ...
                        <h3>${asociacion.status}</h3>
                    </div>
                    <div class="span4">
                        <h4><s:message code="union.label" /></h4>
                        <h3>${asociacion.union.nombre}</h3>
                    </div>
                </div>

                <p class="well">
                    <a href="<c:url value='/colportaje/asociacion/edita/${asociacion.id}' />" class="btn btn-primary btn-large"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                    <form:hidden path="id" />
