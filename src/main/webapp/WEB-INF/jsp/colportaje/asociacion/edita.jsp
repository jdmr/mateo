...
<html>
    ...
    <body>
        ...
        <div id="edita-asociacion" class="content scaffold-list" role="main">
            ...
            <c:url var="actualizaUrl" value="/colportaje/asociacion/actualiza" />
            <form:form commandName="asociacion" method="post" action="${actualizaUrl}">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/colportaje/asociacion/ver/${asociacion.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    </body>
