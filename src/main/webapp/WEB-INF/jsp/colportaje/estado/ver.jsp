    ...
    <body>
        ...
        <div id="ver-estado" class="content scaffold-list" role="main">
            ...
            <p class="well">
                ...
                <a class="btn btn-primary" href="<s:url value='/colportaje/estado/nueva'/>"><i class="icon-file icon-white"></i> <s:message code='estado.nueva.label' /></a>
            </p>
            ...
            <c:url var="eliminaUrl" value="/colportaje/estado/elimina" />
            <form:form commandName="estado" action="${eliminaUrl}" >
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    ...
                    <div class="span4">
                        ...
                        <h3>${estado.pais.nombre}</h3>
                    </div>
                </div>

                <p class="well">
                    <a href="<c:url value='/colportaje/estado/edita/${estado.id}' />" class="btn btn-primary btn-large"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                    <form:hidden path="id" />
