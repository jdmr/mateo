...
<html>
    <head>
        <title><s:message code="planMensualOracion.label" /></title>
    </head>
    <body>
        <jsp:include page="./menu.jsp" >
            <jsp:param name="menu" value="planMensualOracion" />
        </jsp:include>

        <h1><s:message code="planMensualOracion.label" /></h1>
        <hr/>

        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/colportaje/reportes/planMensualOracion' />">
            ...
            <table id="lista" class="table table-striped table-hover">
                ...
                <tbody>
                    <c:forEach items="${planMensualOracion}" var="clp" varStatus="status">
