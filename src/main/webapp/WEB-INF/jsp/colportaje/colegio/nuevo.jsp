...
<html>
    ...
    <body>
        ...
        <div id="nuevo-colegio" class="content scaffold-list" role="main">
            ...
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/colportor/colegio'/>"><i class="icon-list icon-white"></i> <s:message code='colegio.lista.label' /></a>
            </p>
            <form:form commandName="colegio" action="graba" method="post">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/colportor/colegio'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    </body>
