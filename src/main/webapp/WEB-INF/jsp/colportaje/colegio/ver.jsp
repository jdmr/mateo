...
<html>
    ...
    <body>
        ...
        <div id="ver-colegio" class="content scaffold-list" role="main">
            ...
            <c:url var="eliminaUrl" value="/colportaje/colegio/elimina" />
            <form:form commandName="colegio" action="${eliminaUrl}" >
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    ...
                    <div class="span4">
                        ...
                        <h3>${colegio.status}</h3>
                    </div>
                </div>

                <p class="well">
                    <a href="<c:url value='/colportaje/colegio/edita/${colegio.id}' />" class="btn btn-primary btn-large"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                    <form:hidden path="id" />
