...
<html>
    ...
    <body>
        ...
        <div id="edita-colportor" class="content scaffold-list" role="main">
            ...
            <c:url var="actualizaUrl" value="/colportaje/colportor/actualiza" />
            <form:form commandName="colportor" method="post" action="${actualizaUrl}">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/colportaje/colportor/ver/${colportor.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    </body>
