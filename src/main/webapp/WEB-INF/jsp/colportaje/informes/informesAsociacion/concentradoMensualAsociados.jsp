...
<html>
    <head>
        <title><s:message code="concentradoAsociados.label" /></title>
    </head>
    <body>
        <jsp:include page="../menu.jsp" >
            <jsp:param name="menu" value="concentradoAsociados" />
        </jsp:include>

        <h1><s:message code="concentradoAsociados.label" /></h1>
        <hr/>

        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/colportaje/informes/informeConcentradoMensualAsociados' />">
