...
<html>
    ...
    <body>
        ...
        <div id="edita-pedidoColportorItem" class="content scaffold-list" role="main">
            ...
            <form:form commandName="pedidoColportorItem" method="post" action="crea">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/colportaje/ventas/items'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
