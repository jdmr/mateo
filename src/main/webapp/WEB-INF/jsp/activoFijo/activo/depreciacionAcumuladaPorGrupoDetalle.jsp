...
<html>
    <head>
        <title><s:message code="depreciacionAcumuladaPorGrupoDetalle.label" arguments="${tipoActivoId}" /></title>
    </head>
    <body>
        ...
        <h1><s:message code="depreciacionAcumuladaPorGrupoDetalle.label" arguments="${tipoActivo.nombre}" /></h1>
        <hr/>
        <table id="lista" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th><s:message code="fechaDepreciacion.label" /></th>
