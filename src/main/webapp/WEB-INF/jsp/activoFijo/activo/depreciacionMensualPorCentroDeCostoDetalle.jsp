...
<html>
    <head>
        <title><s:message code="depreciacionMensualPorCentroDeCostoDetalle.label" arguments="${centroCostoId}, ${fecha}" /></title>
    </head>
    <body>
        ...
        <h1><s:message code="depreciacionMensualPorCentroDeCostoDetalle.label" arguments="${centroCosto.nombre}, ${fecha}" /></h1>
        <hr/>
