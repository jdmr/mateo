...
<html>
    <head>
        <title><s:message code="depreciacionAcumuladaPorCentroDeCostoDetalle.label" arguments="${centroCosto.nombre},${fecha}" /></title>
    </head>
    <body>
        ...
        <h1><s:message code="depreciacionAcumuladaPorCentroDeCostoDetalle.label" arguments="${centroCosto.nombre},${fecha}" /></h1>
        <hr/>
