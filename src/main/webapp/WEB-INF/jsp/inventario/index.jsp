...
<html>
    <head>
        <title><s:message code="inventario.label" /></title>
    </head>
    <body>
        <nav class="navbar navbar-fixed-top" role="navigation">
            <ul class="nav">
                <li><a href="<c:url value='/inicio' />"><s:message code="inicio.label" /></a></li>
                <li class="active"><a href="<c:url value='/inventario' />"><s:message code="inventario.label" /></a></li>
        ...
        <h1><s:message code="inventario.label" /></h1>
