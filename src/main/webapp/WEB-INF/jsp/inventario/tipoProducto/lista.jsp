...
<html>
    <head>
        <title><s:message code="tipoProducto.lista.label" /></title>
    </head>
    <body>
        ...
        <h1><s:message code="tipoProducto.lista.label" /></h1>
        <hr/>

        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/inventario/tipoProducto' />">
            ...
            <table id="lista" class="table">
                ...
                <tbody>
                    <c:forEach items="${tiposDeProducto}" var="tipoProducto" varStatus="status">
                        <tr class="${status.index % 2 == 0 ? 'even' : 'odd'}">
                            <td><a href="<c:url value='/inventario/tipoProducto/ver/${tipoProducto.id}' />">${tipoProducto.nombre}</a></td>
                            <td>${tipoProducto.descripcion}</td>
                            <td>${tipoProducto.almacen.nombre}</td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
