...
<html>
    ...
    <body>
        ...
        <div id="ver-almacen" class="content scaffold-list" role="main">
            ...
            <c:url var="eliminaUrl" value="/inventario/almacen/elimina" />
            <form:form commandName="almacen" action="${eliminaUrl}" >
                ...
                <p class="well">
                    <a href="<c:url value='/inventario/almacen/edita/${almacen.id}' />" class="btn btn-primary btn-large"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                    <form:hidden path="id" />
