...
<html>
    <head>
        <title><s:message code="salida.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="nueva-salida" class="content scaffold-list" role="main">
            <h1><s:message code="salida.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/inventario/salida/actualiza" />
            <form:form commandName="salida" action="${actualizaUrl}" method="post">
                <form:hidden path="id" />
