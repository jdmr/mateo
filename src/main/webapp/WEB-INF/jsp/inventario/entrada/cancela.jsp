...
<html>
    <head>
        <title><s:message code="entrada.cancela.label" /></title>
    </head>
    <body>
        ...
        <h1><s:message code="entrada.cancela.label" /></h1>
        <hr/>
        ...
        <c:url var="cancelarUrl" value="/inventario/entrada/cancelar" />
        <form:form action="${cancelarUrl}" commandName="entrada" >
            <fieldset>
