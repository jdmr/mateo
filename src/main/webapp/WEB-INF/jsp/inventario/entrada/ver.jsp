        ...
        <div id="ver-entrada" class="content scaffold-list" role="main">
            ...
            <form:form commandName="entrada" action="${eliminaUrl}" >
                ...
                <c:if test="${puedeEditar || puedeCerrar || puedePendiente || puedeEliminar || puedeEditarPendiente}">
                    <p class="well">
                        <c:if test="${puedeEditar}">
                            <a href="<c:url value='/inventario/entrada/edita/${entrada.id}' />" class="btn btn-primary btn-large"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                            <a href="<c:url value='/inventario/entrada/lote/${entrada.id}' />" class="btn btn-success btn-large"><i class="icon-shopping-cart icon-white"></i> <s:message code="lote.nuevo.button" /></a>
                        </c:if>
