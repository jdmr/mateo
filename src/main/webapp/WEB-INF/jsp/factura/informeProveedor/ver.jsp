...
<html>
    <head>
        <title><s:message code="informeProveedor.ver.label" /></title>
    </head>
    <body>
        ...
        <div id="ver-colegio" class="content scaffold-list" role="main">
            <h1><s:message code="informeProveedor.ver.label" /></h1>
            ...
            <c:url var="eliminaUrl" value="/factura/informeProveedor/elimina" />
            <form:form commandName="informeProveedor" action="${eliminaUrl}" >
                ...
                <div class="row-fluid" style="padding-bottom: 10px;">
                    ...
                    <div class="span11">${informeProveedor.nombreProveedor}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="numeroNomina.label" /></div>
                    <div class="span11">${informeProveedor.status}</div>
                </div>
                <div class="row-fluid" style="padding-bottom: 10px;">
                    <div class="span1"><s:message code="numeroNomina.label" /></div>
                    <div class="span11">${informeProveedor.fechaInforme}</div>
                </div>
