...
<html>
    <head>
        <title><s:message code="informeProveedor.edita.label" /></title>
    </head>
    <body>
        ...
        <div id="edita-colegio" class="content scaffold-list" role="main">
            <h1><s:message code="informeProveedor.edita.label" /></h1>
            <p class="well">
            ...
            <c:url var="actualizaUrl" value="/factura/informeProveedor/actualiza" />
            <form:form commandName="informeProveedor" method="post" action="${actualizaUrl}">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/factura/informeProveedor/ver/${informeProveedor.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
