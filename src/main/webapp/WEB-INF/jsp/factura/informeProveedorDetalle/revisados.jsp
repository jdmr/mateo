...
<html>
    ...
    <body>
        <jsp:include page="../menu.jsp" >
            <jsp:param name="menu" value="asignarFecha" />
        </jsp:include>
        ...
        <div id="nuevo-colegio" class="content scaffold-list" role="main">
            ...
            <form name="filtraLista" class="form-search" method="post" action="<c:url value='/factura/informeProveedorDetalle/listaRevisados' />">
