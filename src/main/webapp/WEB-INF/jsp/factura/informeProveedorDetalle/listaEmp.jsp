...
<html>
    ...
    <body>
        ...
        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/factura/informeProveedorDetalle' />">
            ...
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/factura/informeProveedorDetalle/nuevoEmp'/>"><i class="icon-user icon-white"></i> <s:message code='informeProveedorDetalle.nuevo.label' /></a>
