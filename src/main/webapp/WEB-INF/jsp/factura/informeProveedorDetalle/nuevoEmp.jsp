...
<html>
    ...
    <body>
        ...
        <div id="nuevo-colegio" class="content scaffold-list" role="main">
            ...
            <form:form commandName="informeProveedorDetalle" method="${flowExecutionUrl}" enctype="multipart/form-data">
               <input type="hidden" name="_flowExecutionKey" value="${flowExecutionKey}"/>
                ...
                <p class="well" style="margin-top: 10px;">
                    <button type="submit" name="_eventId_grabaEncabezado" class="btn btn-primary btn-large" id="_ventId_grabaEncabezado" ><i class="icon-ok icon-white"></i>&nbsp;<s:message code='crear.button'/></button>
