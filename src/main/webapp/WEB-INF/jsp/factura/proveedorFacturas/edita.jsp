...
<html>
    <head>
        <title><s:message code="proveedorFacturas.edita.label" /></title>
    ...
    <body>
        ...
        <div id="edita-usuario" class="content scaffold-list" role="main">
            <h1><s:message code="proveedorFacturas.edita.label" /></h1>
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/facturas/proveedorFacturas'/>"><i class="icon-list icon-white"></i> <s:message code='proveedorFacturas.lista.label' /></a>
            </p>
            <c:url var="actualizaUrl" value="/factura/proveedorFacturas/actualiza" />
            <form:form commandName="proveedorFacturas" method="post" action="${actualizaUrl}">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/factura/proveedorFacturas/ver/${proveedorFacturas.id}'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
    <content>
