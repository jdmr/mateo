...
<html>
    ...
    <body>
        ...
        <div id="nuevo-tipoCliente" class="content scaffold-list" role="main">
            ...
            <form:form commandName="tipoCliente" action="crea" method="post">
                <form:errors path="*">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-large" href="<s:url value='/admin/tipoCliente'/>"><i class="icon-remove"></i> <s:message code='cancelar.button' /></a>
                </p>
            </form:form>
        </div>
        <content>
