...
public class Puesto implements Serializable {
    ...
    public Puesto(String descripcion, Empresa empresa) {
    ...
    public String toString() {
        return "Puesto{" + "id=" + id + ", descripcion=" + descripcion + ", categoria=" + categoria
                + ", minima=" + minimo + ", maxima=" + maximo + ", status=" + status
                + ", rangoAcademico=" + rangoAcademico + ", version=" + version + '}';
    }
