...
public class SpringSecurityUtils {
    ...
    /**
     * Find authorities in
     * <code>granted</code> that are also in
     * <code>required</code>.
     *
     ...
     * @return
     * <code>true</code> if the user is authenticated and has all the roles
     */
     ...
     * @param roles a comma-delimited list of role names
     * @return
     * <code>true</code> if the user is authenticated and has none the roles
     */
     ...
     * @param roles a comma-delimited list of role names
     * @return
     * <code>true</code> if the user is authenticated and has any the roles
     */
     ...
     *
     * @return
     * <code>true</code> if logged in and switched
     */
    ...
    private Collection<GrantedAuthority> findInferredAuthorities(
        ...
        Collection<GrantedAuthority> reachable = (Collection<GrantedAuthority>) roleHierarchy.getReachableGrantedAuthorities(granted);
        if (reachable == null) {
            return Collections.emptyList();
        }
        return reachable;
