...
public class Constants {
    ...
    //MathContext
    public static final MathContext mc = new MathContext(12, RoundingMode.HALF_EVEN);
	...
	/**
	 * Columna del debe.
	 * En naturaleza C, corresponde a los cargos
	 * En naturaleza D, corresponde a los creditos
	 */
	public static final String NATURALEZA_DEBE = "D";
	/**
	 * Columna del haber.
	 * En naturaleza D, corresponde a los cargos
	 * En naturaleza C, corresponde a los creditos
	 */
	...
	/**
	 * Formato (yyyy-MM-dd) de la fecha en el cual el mes se representa numericamente.
	 */
	...
	/**
	 * Formato (dd/MM/yyyy hh:mm) de la fecha en el cual el mes se representa numericamente incluyendo la hora:minutos:segundos am/pm
	 */
	...
	/**
	 * Formato (dd/MMM/yyyy) de la fecha en el cual el mes se representa en palabra
	 */
	...
	/**
	 * Formato (HH:mm hrs.) de una fecha en la cual se muestra sola hora en formato de 24 horas Ej.(15:30 hrs)
	 */
    ...
    public static final String DATE_24_HOUR_HUMAN_PATTERN = "dd/MMM/yyyy HH:mm";
        ...
        public static final String STATUS_ENTREGADO = "S";
        
        public static final String STATUS_NO_ENTREGADO = "N";

        public static final String FILES_LIST = "filesList";

        /**
         * Este status se utiliza para realizar <b>busquedas</b> donde el valor del status de los registros debe incluir 'Inscritos' y 'Confirmados'
         * <br><b>No se utiliza para asignar dicho valor a registro alguno</b>
         */
	...
	/**
        ...
        */
        ...
        /**
         * Precio por hora que se considera para calcular el diezmo de todos los contratos
         */
         public static final BigDecimal AFE_BECA_DIEZMO = new BigDecimal("7.39");
         /**
          * Precio por hora que se considera para calcular el diezmo de los contratos de confianza
          */
         public static final BigDecimal AFE_BECA_DIEZMO_INSTITUCIONAL = new BigDecimal("52.80");
         /**
          * Numero de horas que debe trabajar un alumno de bachilleres con beca basica
          */
         public static final Integer AFE_BECA_HRS_BACH = 230;
         /**
          * Numero de horas que debe trabajar un alumno de universidad con beca basica
          */
         public static final Integer AFE_BECA_HRS_UNIV = 320;
         /**
          * Numero de horas que debe trabajar un alumno de maestria con beca basica
          */
         public static final Integer AFE_BECA_HRS_MTRIA = 608;
         /**
          * Numero de horas que debe trabajar un alumno industrial
          */
         public static final Integer AFE_BECA_HRS_INST = 500;
         /**
          * Numero de horas que debe trabajar un alumno que recibe una beca del tipo Otras Becas
          */
         public static final Integer AFE_BECA_HRS_OTRAS = 500;
         /**
          * Importe de la beca basica o regular para los industriales
          */
         public static final BigDecimal AFE_BECA_REGULAR_IMPORTE_INDUSTRIALES = new BigDecimal("26400");
...
//  EmpleadoPuesto-START
    ...
    /**
     * The request scope attribute that holds the empleadoPuesto value that has been edited
     */     
...
//CentroCosto-START
    ...
    /**
     * Clave de CCosto de Autofinanciamiento estudiantil
     */
    public static final String CCOSTO_AUTOFIN = "1.01.4.04.12";
    
    public static final String CCOSTO_FONDOS_BECAS = "1.01.4.04.12";
    /**
     * Fondos de excedente de becas 1, 2, y 3
     */
    public static final String CCOSTO_FONDOS_BECAS_123 = "1.01.4.07.02";
...
//  CtaMayor-START
    ...
    public static final String CTAMAYOR_PRESUPUESTO_OTRAS_BECAS = "1.3.19";
    
    public static final String CTAMAYOR_PRESUPUESTO_SERVICIO_BECARIO = "1.3.05";
    
    public static final String CTAMAYOR_PRESUPUESTO_EXCEDENTE_BECAS_REGULAR = "1.3.07";
    
    public static final String CTAMAYOR_PRESUPUESTO_EXCEDENTE_BECAS_CONFIANZA = "1.3.08";
    
    public static final String CTAMAYOR_PRESUPUESTO_EXCEDENTE_BECAS_ESPECIALES = "1.3.09";
    ...
    /**
     * Cuenta de Mayor de los convenios de confianza, la parte del servicio becario
     */
    public static final String CTAMAYOR_BECA_INSTITUCIONAL_BB = "1.3.05";
    /**
     * Cuenta de Mayor de los convenios de confianza, la parte del excedente
     */
    public static final String CTAMAYOR_BECA_INSTITUCIONAL_B2 = "1.3.15";
...
//Auxiliar-START
    ...
    /**
     * Clave de auxiliar default
     * Se utiliza cuando el usuario no proporciona una clave de auxiliar
     */
...
//  Cuenta-START
    ...
    /**
     * Cuenta inactiva
     * No se pueden crear, modificar o borrar movimientos en esta cuenta
...
//  Poliza-START
    ...
    /**
     * Poliza cerrada.
     * Si esta cerrada debe estar cuadrada.
     */
    ...
    /**     
     * Acumula los importes de los movimientos con cuenta, naturaleza y descripcion iguales 
     */
    public static final String POLIZA_COMPORTAMIENTO_BY_DESCRIPCION = "Descripcion";
    /**     
     * Acumula los importes de los movimientos con cuenta, naturaleza y descripcion, tomando en cuenta la referencia
     */
...
//Movimiento-START
    ...
    /**
     * Movimiento que cancela caja, y queda en espera que auditoria lo cancele definitivamente
     */
...
//Concepto-START
     ...
     */
    public static final String CONCEPTO_KEY = "conceptoForm";
    /**
     ...
     */
    public static final Integer CONCEPTO_MATRICULA_EXTEMPORANEA_ID = new Integer(35);
    /**
    ...
    /**
     * Id del concepto de otro, se utiliza en casos donde no se ha definido el concepto correcto
     */
...
//Empleado-START
	...
	/**
	 * Guarda la clave del empleado cuando este ingresa a la pagina de consulta de estado de cuenta de SS
	 */
...
//Sobresueldo-START
    ...
    /**
     * Valor que se envia como parametro en el request para indicar 
     * que la cancelacion sera automatica
     */
...
//    public static final String PERDED_SEGURO_INFO_NOMBRE = "Seguro Infonavit";
...
//TipoConvenio-START
    ...
    /**
     * Indica el orgien del llamado para el method=Edit:
     * si este viene de TipoConvenioFecha (fecha), o si viene de TipoConvenioList
     * Este origen se utiliza en global-forwards.xml
     */
...
//SolicitudSalida-START
    ...
    /**
     * Inidica que se quiere consultar las solicitudes (sin importar el status) del empleado en session
     */
...
//BecaAFEAlumno-START
    ...
    public static final BigDecimal BECAAFEALUMNO_PCT_TOPE =new BigDecimal("0.67");
//BecaAFEAlumno-END
...
//TipoAFEBeca - START
    public static final String TIPOAFEBECA_LIST = "tipoAFEBecaList";
    public static final String TIPOAFEBECA_KEY = "tipoAFEBecaForm";
//TipoAFEBeca - END
}
